...
import { Star, Calendar, Tv, Play, Sparkles } from "lucide-react";
    ...
    return (
        <Carousel className="w-full max-w-[95%] lg:max-w-[90%] mx-auto ">
            <Badge className=" ml-5 mt-2 absolute flex items-center gap-2 text-yellow-300 z-10  bg-black/70 backdrop-blur-md rounded-full ">
                ...
                <span className=" text-xs xl:text-xl font-semibold tracking-wider uppercase">Featured Anime</span>
            </Badge>
            <CarouselContent className="px-5 ">
                ...
                {PopularData.map((data, index) => (
                    ...
                    <CarouselItem key={index} className="  py-2 sm:py-4 cursor-pointer relative w-full aspect-[16/9] sm:aspect-[21/9] lg:aspect-[2.5/1] mx-4 rounded-xl overflow-hidden border border-white/10 !shadow-none group">
