...
export default function AllMangaGenresPage() {
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="py-8">
          <div className="relative mb-6">
            <div className="absolute inset-0 dark:bg-gradient-to-r from-orange-500 to-yellow-500 blur-xl opacity-50" />
            <h1 className="relative text-4xl md:text-5xl font-black bg-gradient-to-r from-orange-400 via-yellow-400 to-red-500 bg-clip-text text-transparent">
              All Manga Genres
            </h1>
          </div>
          <p className="text-muted-foreground">
            Browse {genres.length} manga genres and find your next read
          </p>
        </div>
        ...
        {/* Genre Statistics */}
        {filteredGenres.length > 0 && (
          <Card className="p-6 bg-gradient-to-r from-orange-500/10 to-yellow-500/10 border-orange-500/20">
            <div className="text-center">
              ...
              <p className="text-xs text-muted-foreground mt-2">
                Click on any genre to see all manga in that category
              </p>
            </div>
          </Card>
        )}
